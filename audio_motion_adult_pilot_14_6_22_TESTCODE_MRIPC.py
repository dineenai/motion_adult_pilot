...
<<<<<<< HEAD:audio_motion_adult_pilot_14_6_22_TESTCODE.py

        print(f"TESTTTTTT: {nextFlip+audio_delay}, NOW {datetime.now()}, ")
        print(datetime.now().strftime("%H:%M:%S:%f"))
        print(audio_delay + _timeToFirstFrame)
        turn_white_timer = core.Clock()
        # print(f"timeer {turn_white_timer.getTime()}")
        turn_white_timer.reset()
        # if timer.getTime() >=3:
        #     circle.lineColor='red'
        
        # circle.lineColor='red'


        # set circle to be white 
...
>>>>>>> fc7b53395a56eef77c7054a7617f83abbc47e16a:audio_motion_adult_pilot_14_6_22.py
...
<<<<<<< HEAD:audio_motion_adult_pilot_14_6_22_TESTCODE.py
            ...
            if turn_white_timer.getTime() >=(audio_delay + _timeToFirstFrame):
=======
