...
import audio_motion_adult_pilot_14_6_22_scan
...
# aud_file12 = 'PhoneCallHome_5' #5 00
# # aud_file34 = 'PieMan_5min' # 5 01
# aud_file34 = 'PieMan_5min_MBC_12_5_22'
# # PieMan_5min_MBC_12-5-22
...
while True: 
    ...
    if 'e' in keys:
        ...
        # CHANE BACK 5/8/22
        audio_motion_adult_pilot_14_6_22_scan.run_trial(win, audio, aud_file, save_aud_status_loc, MR_settings, save_loc,  Session_Info, subNum) 
