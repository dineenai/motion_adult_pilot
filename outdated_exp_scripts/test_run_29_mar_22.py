...
hist_file = os.path.join(root_dir,'vis_met_test.csv')
...
infoDlg = gui.DlgFromDict(Session_Info, title='Session Info', order=['PID'])
...
# ADD MOTION/STILL - check logs for still ( a and c button presses)
...
save_dir = os.path.join(root_dir,'trial_run_logs', f'sub-{_subj}','test')
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
save_loc = os.path.join(save_dir,f'sub-{_subj}_task-test_metrenome_events.tsv')
